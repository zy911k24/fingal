...
from fingal import readElectrodeLocations, readSurveyData, DCInversionByFieldIntensity, getR2, ChargeabilityInversionByField
...
sigma.expand()
outargs={ "tag" : getRegionTags(Function(domain)), "sigma":sigma }
